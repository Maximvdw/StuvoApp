...
function onDeviceReady() {
  var db = window.sqlitePlugin.openDatabase({name: "stuvo.db"});
   db.transaction(function(tx) {
    ...
    tx.executeSql("INSERT INTO settings (setting,value) VALUES (?,?)", ["notifications_events", "0"], function(tx, res){}, function(e){});
    tx.executeSql("INSERT INTO settings (setting,value) VALUES (?,?)", ["notifications_news", "1"], function(tx, res){}, function(e){});
